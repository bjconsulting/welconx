                    ...
                    <Glider
                     ...
                     className="">
                        <div className='relative'>
                            <img className=' aspect-auto max-w-[250px] laptop:max-w-[400px] desktop:max-w-[400px] mx-auto' src={img} alt="Mini Market" />
                            <p className='absolute right-4 bottom-4 uppercase text-[.4em]'> perspectiva ilustrada da lavanderia</p>
                        </div>

                        <div className='relative'>
                            <img className=' aspect-auto max-w-[250px] laptop:max-w-[400px] desktop:max-w-[400px] mx-auto' src={img2} alt="Lavanderia" />
                            <p className='absolute right-4 bottom-4 uppercase text-[.4em]'> perspectiva ilustrada da lavanderia</p>
                        </div>
