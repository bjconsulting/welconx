...
export default function Dobra10() {
  return(
    <div className='max-w-[70%] mx-auto flex flex-col tablet:flex-row items-start text-center justify-around gap-32 laptop:gap-12 pt-20 pb-20 font-semibold text-base'>
