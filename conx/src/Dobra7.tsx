...
function Dobra7(){
    return(
        ...
        <div className="laptop:px-24 pb-10 px-4 relative tablet:pb-0 flex desktop:flex-row laptop:flex-row gap-24 justify-start items-center bg-prim pt-8 flex-col laptop:min-h-[60vh] laptop:h-[60vh] laptop:max-h-[65vh]">
